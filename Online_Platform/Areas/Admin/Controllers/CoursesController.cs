namespace Online_Platform.Areas.Admin.Controllers
{
    ...
    using Online_Platform.Services.Admin;
    using Online_Platform.Areas.Admin.Controllers;
    using Online_Platform.Areas.Admin.Models.Courses;
    ...
    public class CoursesController : BaseAdminController
    {
        ...
        public async Task<IActionResult> Create(CourseFormModel model)
        {
            ...
            return this.RedirectToAction(nameof(Online_Platform.Controllers.CoursesController.Index), WebConstants.CoursesController);
        }
        ...
        public async Task<IActionResult> Edit(int id, CourseFormModel model)
        {
            ...
            return this.RedirectToAction(
                nameof(Online_Platform.Controllers.CoursesController.Details),
